namespace ContosoUniversity.Migrations
{
    ...
    public partial class Inheritance : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Enrollment", new[] { "Student_PersonID" });
            ...
            DropForeignKey("dbo.Enrollment", "Student_PersonID", "dbo.Person");
            ...
            RenameColumn(table: "dbo.Enrollment", name: "Student_PersonID", newName: "StudentID");
